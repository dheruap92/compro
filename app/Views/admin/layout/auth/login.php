            ...
            <div class="container-tight">
              ...
              <div class="card card-md">
                <div class="card-body">
                  ...
                  <form action="<?= base_url() ?>tabler/" method="get" autocomplete="off" novalidate>
                    <div class="mb-3">
                    ...
                    <div class="mb-2">
                      <label class="form-label">
                        ...
                        <span class="form-label-description">
                          <a href="<?= base_url() ?>tabler/forgot-password.html">I forgot password</a>
                        </span>
                      </label>
              ...
              <div class="text-center text-muted mt-3">
                Don't have account yet? <a href="<?= base_url() ?>tabler/sign-up.html" tabindex="-1">Sign up</a>
              </div>
            </div>
          </div>
